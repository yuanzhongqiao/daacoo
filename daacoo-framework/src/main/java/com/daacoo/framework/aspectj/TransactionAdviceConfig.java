...
public class TransactionAdviceConfig {
     ...
     * 多个切入点表达式使用 and
     */
//	private static final String AOP_POINTCUT_EXPRESSION = "execution(* com.daacoo.*.service.impl.*.*(..)) and execution(* com.daacoo.activiti.service.*.*(..))";
    private static final String AOP_POINTCUT_EXPRESSION = "execution(* com.daacoo.*.service.impl.*.*(..))";
