package com.daacoo.common.utils.poi;

import com.daacoo.common.annotation.Excel;
import com.daacoo.common.annotation.Excel.ColumnType;
import com.daacoo.common.annotation.Excel.Type;
import com.daacoo.common.annotation.Excels;
...
import com.daacoo.common.exception.UtilException;
import com.daacoo.common.utils.DateUtils;
import com.daacoo.common.utils.DictUtils;
import com.daacoo.common.utils.StringUtils;
import com.daacoo.common.utils.file.FileTypeUtils;
import com.daacoo.common.utils.file.FileUtils;
import com.daacoo.common.utils.file.ImageUtils;
import com.daacoo.common.utils.reflect.ReflectUtils;
                ...
                for (Map.Entry<Integer, Object[]> entry : fieldsMap.entrySet())
                {
                    ...
                    if (String.class == fieldType)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                val = Convert.toStr(((String) val).trim());
                            }
                        }
                    }
                    ...
                    else if (Date.class == fieldType)
                    {
                        ...
                        {
                            val = DateUtils.parseDate(((String) val).trim());
                        }
