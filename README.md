...
- **Mar 1 2026:** DaaCoo just launched Local AI Toys on Pi Day.🎉🎉 Your ESP32 devices can now support local AI models and voice generation with frontier Local LLMs and TTS models like Qwen, Mistral, and more with MLX. Check it out [here](https://github.com/yuanzhongqiao/deeptoys). 
