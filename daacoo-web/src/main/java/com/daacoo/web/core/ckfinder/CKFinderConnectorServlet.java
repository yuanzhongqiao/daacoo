...
import com.daacoo.file.manager.connector.ConnectorServlet;
...
public class CKFinderConnectorServlet {
    ...
    /** 文件保存路径 */
    @Value("${daacoo.profile}")
    private String profile;

    /** 是否启用CKFinder插件 */
    @Value("${daacoo.ckfinderEnabled}")
    ...
    public ServletRegistrationBean connectCKFinder() {
        ...
        registrationBean.addInitParameter("configuration", "com.daacoo.web.core.ckfinder.CKFinderConfig");
