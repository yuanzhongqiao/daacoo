!function (t) {
    ...
    i.chuncai = function (t) {
        var e = {
            daacoo: {key: "123456", userid: "asdfwerwer"},
            menu: {
                key: "主人，您想做点什么呢？>ω<",
                "显示公告": function () {
                ...
                "传送大门": {
                    "GitEE": function () {
                        window.open("https://gitee.com/daacoo_dlsdys/daacoo")
                    },
                    "GitHub": function () {
                        window.open("https://github.com/daacoo-dlsdys/daacoo")
                    }
                },
            },
    ...
    t.exports = "/daacoo/cms/image/chuncai/png/face00.png"
}, function (t, e) {
    t.exports = "/daacoo/cms/image/chuncai/png/face-eyes.png"
}, function (t, e) {
    t.exports = "/daacoo/cms/image/chuncai/png/face01.png"
}, function (t, e) {
    t.exports = "/daacoo/cms/image/chuncai/png/face02.png";
}, function (t, e) {
    t.exports = "/daacoo/cms/image/chuncai/jpeg/ok.jpg"
}, function (t, e, n) {
    function i(t, e) {
    ...
    var f = function () {
        ...
        return a(t, [{
            key: "init", value: function () {
                this.fill(), this.postdaacoo(c), A(this.ele.children(".chuncai-face"), this.ele, this.savePos.bind(this)), o(this.ele.children(".chuncai-face"), this.ele, this.savePos.bind(this)), this.bindMenuEvents(), this.bindTalkEvents(), this.show()
            }
        }, {
            key: "postdaacoo", value: function (t) {
                var e = this;
                t === c ? (r.post("/daacoo/cms/api", {
                    key: e.opt.daacoo.key,
                    info: "讲个笑话吧",
                    userid: e.opt.daacoo.userid
                }, function (t, n) {
                    "success" == n && (e.opt.words.push(t.text), e.opt.jokepos = e.opt.words.length - 1)
                }), r.post("/daacoo/cms/api", {
                    key: e.opt.daacoo.key,
                    info: "讲个故事吧",
                    userid: e.opt.daacoo.userid
                }, function (t, n) {
                    "success" == n && (e.opt.words.push(t.text), e.opt.storypos = e.opt.words.length - 1)
                })) : t == u ? r.post("/daacoo/cms/api", {
                    key: e.opt.daacoo.key,
                    info: "讲个笑话吧",
                    userid: e.opt.daacoo.userid
                }, function (t, n) {
                    "success" == n && (e.opt.words[e.opt.jokepos] = t.text)
                }) : t == s && r.post("/daacoo/cms/api", {
                    key: e.opt.daacoo.key,
                    info: "讲个故事吧",
                    userid: e.opt.daacoo.userid
                }, function (t, n) {
            ...
            key: "freeSay", value: function (t) {
                ...
                clearInterval(this.freeSayTimer), t && (e.dynamicSay(e.opt.syswords[0]), e.ele.find(".chuncai-face").attr("class", "chuncai-face chuncai-face-0" + Math.floor(3 * Math.random()))), this.freeSayTimer = setInterval(function () {
                    if (e.allowswitchword) {
                        ...
                        e.dynamicSay(e.opt.words[t]), t == e.opt.jokepos ? e.postdaacoo(u) : t == e.opt.storypos && e.postdaacoo(s), e.ele.find(".chuncai-face").attr("class", "chuncai-face chuncai-face-0" + Math.floor(3 * Math.random()))
                    }
                }, 1e4)
            }
        }, {
            ...
            key: "bindTalkEvents", value: function () {
                ...
                e.keypress(function (e) {
                    ...
                    t.menuOn && t.closeMenu(p), r.post("/daacoo/cms/api", {
                        key: t.opt.daacoo.key,
                        info: e.val(),
                        userid: t.opt.daacoo.userid
                    }, function (n, i) {
