...
# 👾 答 酷  DaaCoo AI：在 Arduino ESP32 上运行实时语音 AI 模型
...
- [在 Arduino IDE 中构建](https://www.daacoo.com/docs/arduino)
- [全球部署](https://www.daacoo.com/docs/blog/deploying-globally)
- [🤖🤖🤖 部署多台设备](https://www.daacoo.com/docs/blog/multiple-devices)

## 📽️ 演示视频

<div align="center">
    <a href="https://www.youtube.com/watch?v=o1eIAwVll5I" target="_blank">
    <img src="https://raw.githubusercontent.com/akdeb/DaaCoo AI/refs/heads/main/assets/thumbnail.png" alt="DaaCoo AI Demo Video" width="100%" style="border-radius:10px" />
  </a>
</div>
...
通过 DaaCoo AI Web 应用，你可以直接在手机上控制自己的 ESP32 AI 设备。
...
**欢迎查看我们的硬件产品：[DaaCoo AI Products](https://www.daacoo.com/)。如果你觉得这个项目有趣或有帮助，欢迎在 GitHub 上给它点个 Star。⭐**
